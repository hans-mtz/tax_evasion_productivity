...
- **The paper now goes two steps further than the paragraph above** (validated, ready to write — no prior prose since this is new relative to last year's version):
  - Test whether evasion responds to a real policy change (the 1983 sales-tax reform) — an external check that the FOC-based identification isn't just a modeling artifact.
