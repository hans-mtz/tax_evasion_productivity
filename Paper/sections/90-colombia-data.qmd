...
```{r}
#| label: tbl-reg-tax-jo
#| tbl-cap: Sales tax and Juridical Organization type effect on the log share of intermediate inputs.
#| echo: false
#| warning: false
...
setFixest_dict(c(
    ...
    `factor(fiscal_period)83` = "83-86 fiscal period",
    `factor(fiscal_period)86` = "87-91 fiscal period"
)
...
```{r}
#| label: tbl-reg-fiscal-p
#| tbl-cap: Juridical Organization type per fiscal period effect on the log share of intermediate inputs.
#| echo: false
#| warning: false
