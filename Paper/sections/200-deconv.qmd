...
In both tables, the estimates of correcting the production function parameters are similar. This provides evidence of the robustness of the results to misspecification in the markov process. 
