...
@eq-foc-cont-e solves for the optimal evasion decision. The left-hand side is the marginal benefit net of the marginal cost of evasion. The right-hand side is the rate of change of the probability of detection due to a change in evasion weighted by the benefit and cost of evading.

### Case 1 (Independece): $q(e|\theta)=q(e)$ and $\kappa(e)=\kappa_0$
...
### Case 3 (Colombia): Discrete increase in the tax rate after a revenue threshold
...
### Case 4 (Mexico): Irreversible change in tax regime after a revenue threshold
