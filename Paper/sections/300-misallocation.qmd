## Tax Evasion and Resource Missallocation

A popular way to decompose total productivity introduced by @Olley1996 is the following :
...
There are alternative ways to decompose total productivity that account for the entry and exit of firms (Foster et al. 2008). In addition, alternative measures to aggregate productivity have been used elsewhere (e.g. aggregate demand shocks in @Eslava2004).
