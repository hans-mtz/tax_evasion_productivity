...
To learn $\alpha$ and $h$, we need to find instruments $Z$ such that,
$$
\begin{aligned}    
...
The first line should follow from the orthogonality of the output shock $\mathbb{E}[\varepsilon_{it}|Z_{it}]=0$ and the law of iterated expectations. The second line should follow from the definition of expectation and the independence of the output shock of the previous period. The third line follows from the interchangeability of integrals. Thus, $\alpha$ and $h$ are identified.
