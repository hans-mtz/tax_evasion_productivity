...
#| tbl-cap: Summary statistics of the simulated productivity using the non-parametric estimates of $\omega$ and $\varepsilon$. Both functions were numerically inverted to obtain simulated draws of $\omega$ and $\varepsilon$. 1000 draws were used. Productivity is computed as $\varphi_{it}^S=\exp\{\omega_{it}^S+\varepsilon_{it}^S\}$.
