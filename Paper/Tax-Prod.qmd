...
setFixest_dict(c(
    ...
    `log((materials+deductible_expenses)/sales)` = "Mats+Deduc",
...
- Colombian Manufacturing Firms are Moslty Upstream (Revenue Misreporting) 

## To Do {-}

- Data Summary Statistics
- Look into differences between Corporations and Other JOs at the industry level
  - Pick 4 biggest industries
  - Pick industries with a fair share of corporations
  - Pick industries with simple technology (to reduce concerns about differences in technology), such as sugar refining, cement, steel furnaces, or others (Daniel)
- Capital Misallocation due to CIT rate differentials between Corporations and LLCs
