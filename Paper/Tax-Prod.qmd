...
- Tax Evasion and Productivity: Using PF to identify tax evasion through input overreporting
  - CD
    - Preliminary results of Tax Evasion: Moments, MLE (Normal and LogNormal)
...
- Tax Evasion and Productivity
  ...
  - CD with two flexible inputs (Deductibles & Non-Deductibles, Materials & Services + Energy)
  - Translog results
  - Non-parametric Deconvolution
  - Non-parametric PF
- DiD
  - Relaxing parallel trends: Linear trends that in the absence of policy change would have continue
