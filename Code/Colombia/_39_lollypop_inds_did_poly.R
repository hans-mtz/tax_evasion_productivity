...
local_data <- "beta_inds_did_poly"
plot_title <- "DiD Non-Linear"
...
lapply(
    ...
    \(x){
        ...
        ggsave(
            paste0(fig_dir, local_data, "_", big_industries[[x]], "_by_size_did_poly.", plot_suffix),
            height = 32,
            width = 21,
            units = "cm"
        )
...
lapply(
    ...
    \(x){
        ...
        ggsave(
            paste0(fig_dir, local_data, "_", size[[x]], "_by_inds_did_poly.", plot_suffix),
            height = 32,
            width = 21,
            units = "cm"
        )
