...
local_data <- "beta_inds_diff_poly"
plot_title <- "Non-Linear PF"
...
lapply(
    ...
    \(x){
        ...
        ggsave(
            paste0(fig_dir, local_data, "_", big_industries[[x]], "_by_size.", plot_suffix),
            height = 32,
            width = 21,
            units = "cm"
        )
...
lapply(
    ...
    \(x){
        ...
        ggsave(
            paste0(fig_dir, local_data, "_", size[[x]], "_by_inds.", plot_suffix),
            height = 32,
            width = 21,
            units = "cm"
        )
