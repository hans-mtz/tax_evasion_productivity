...
sales_tax_change<-tribble(
    ...
    311, "exempt", 84, NA,# Exempt in data less than 0.3 %  food prods
    312, "exempt", 84, NA,# Exempt in data less than 0.3 % food prods
    313, "increased", 85, "- to 35;10",# Beverages in data 5 -> 9 (6 -> 10)
    314, NA, 84, "- to 35;10",# NO: Tobacco in data not significant decrease, maybe 82-83 vs 85 (not top 20)
    321, "increased", 84, "6 to 10",# @Perry1990 6 -> 10 Textiles
    322, "increased", 84, "6 to 10",# @Perry1990 6 -> 10 Textiles
    323, "no change", 84, NA,# Leather products in data 8%, no change
    324, "increased", 84, NA,# Footwear in data 6->10
    331, "no change", 84, NA,# Wood and cork products
    332, "decrease", 84, NA,# Furniture, in data small decrease 11->9
    341, "increased", 84, "15 to 10",# Paper, data increase 7->9, Perry decreased 15->10
    342, "decrease", 84, NA,# Printing in small decrease 8->7
    351, "decreased", 84, "(Soap) 6;15 to 10",# Industrial Chemicals @Perry1990 data 8->6
    352, "no change", 84, "15 to 10",# Chemical Products, no change in data 
    353, NA, 83, NA,# Petroleum refineris NO: huge variation.  from 30% to 8% 83 and 2% 84
    354, NA, 84, "10 to 14",# Oil and Coal Derivatives NO:  4%
    355, NA, 84, NA,# Rubber prods. No change, maybe 82 vs 86-91 
    356, "no change", 84, "15 to 10",# Plastic products 
    361, "increase", 85, NA,# Pottery, china, earthware. NO: Increase 81-83 vs 85-88
    362, "increase", 84, NA,# Glass and glass products: In data significant increase 81-83 vs 84-91
    369, "no change", 84, NA,# Non-Metallic mineral products; data significant decrease 81-83 vs 84-90
    371, "increased", 84, "6;15 to 10",# Iron and Steel basic industries; significant increase indata 81-83 vs 84-91
    372, "no change", 84, NA,# Metal basic inds: NO. No significant change in data
    381, "no change", 85, NA,# Metal prods. no machinery. Minor significant increase 81-84 vs 85-91
    382, "increased", 85, "6 to 10",# Machinery mfg no electrical from 8% to 11% in 84, to 14% in 85
    383, "increased", 84, "6 to 10",# Electrical machinery, increase, from 81-83 vs 84-91
    384, "increased", 85, "6 to 10",# Transport equipment, significant increase, 81-84 vs 85-91
    385, NA, 85, NA,# Prof equipment, gradual increase, 81-83 vs 86-91
    390, "no change", 84 ,NA,# Other mfg equipment, gradual decrease, 81-83 vs 87-91
)
# save()
