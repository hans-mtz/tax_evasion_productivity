...
load("Code/Products/930.1-fs-se-het.RData")
...
# save(
#     df, data_all_ls, 
#     file = "Code/Products/930.2-boot-se-het.RData"
# )
...
load("Code/Products/930.2-boot-se-het.RData")
...
tt(res_tbl[,-2]) |>
    ...
    save_tt(
        output = "Paper/images/930.2-boot-se-het-table.tex",
        overwrite = TRUE
    )

tex_tbl <- readLines("Paper/images/930.2-boot-se-het-table.tex")
...
cat(
    ...
    tex_tbl,
    "\\end{document}",
    file = "Paper/tbls/930.2-boot-se-het-table.tex",
    sep = "\n"
)
