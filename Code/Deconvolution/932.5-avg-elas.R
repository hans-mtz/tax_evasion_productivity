...
fmls_nc <- c(
    "cal_V ~ (l_pct+k_pct+exports_pct+imports_pct)^2 + l_pct^2 + k_pct^2 + exports_pct^2 + imports_pct^2| rev_pct + rev_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):rev_pct~ lag_rev_pct + lag_rev_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):lag_rev_pct",
    # "cal_V ~ (l_pct+k_pct+exports_pct+imports_pct)^2 + l_pct^2 + k_pct^2 + exports_pct^2 + imports_pct^2| rev_pct + rev_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):rev_pct~ cap_l_pct + cap_l_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):cap_l_pct",
    # "cal_V ~ (l_pct+k_pct+exports_pct+imports_pct)^2 + l_pct^2 + k_pct^2 + exports_pct^2 + imports_pct^2| rev_pct + rev_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):rev_pct~ lab_l_pct + lab_l_pct^2 +(l_pct+k_pct+exports_pct+imports_pct):lab_l_pct",
    "cal_V ~ (lag_rev_pct+l_pct+k_pct+exports_pct+imports_pct)^2 + lag_rev_pct^2 + l_pct^2 + k_pct^2 + exports_pct^2 + imports_pct^2"
)
...
fmls_elas_iv <- c(
    "~ I(2*fit_rev_pct)+l_pct + k_pct + exports_pct + imports_pct",
    "~ I(2*l_pct)+fit_rev_pct + k_pct + exports_pct + imports_pct",
    "~ I(2*k_pct)+fit_rev_pct + l_pct + exports_pct + imports_pct",
    "~ I(2*exports_pct)+fit_rev_pct + l_pct + k_pct + imports_pct",
    "~ I(2*imports_pct)+fit_rev_pct + l_pct + k_pct + exports_pct"
)
names(fmls_elas_iv) <- var_elas_iv
fmls_elas_ols <- c(
    "~ I(2*lag_rev_pct)+l_pct + k_pct + exports_pct + imports_pct",
    "~ I(2*l_pct)+lag_rev_pct + k_pct + exports_pct + imports_pct",
    "~ I(2*k_pct)+lag_rev_pct + l_pct + exports_pct + imports_pct",
    "~ I(2*exports_pct)+lag_rev_pct + l_pct + k_pct + imports_pct",
    "~ I(2*imports_pct)+lag_rev_pct + l_pct + k_pct + exports_pct"
)
names(fmls_elas_ols) <- var_elas_ols

coef_elas_iv <- list(
    "fit_rev_pct" = c("fit_rev_pct", "fit_I(rev_pct^2)","fit_rev_pct:l_pct", "fit_rev_pct:k_pct", "fit_rev_pct:exports_pct", "fit_rev_pct:imports_pct"),
    "l_pct" = c("l_pct", "I(l_pct^2)", "fit_rev_pct:l_pct", "l_pct:k_pct", "l_pct:exports_pct", "l_pct:imports_pct"),
    "k_pct" = c("k_pct", "I(k_pct^2)","fit_rev_pct:k_pct", "l_pct:k_pct", "k_pct:exports_pct", "k_pct:imports_pct"),
    "exports_pct" = c("exports_pct", "I(exports_pct^2)","fit_rev_pct:exports_pct", "l_pct:exports_pct", "k_pct:exports_pct", "exports_pct:imports_pct"),
    "imports_pct" = c("imports_pct", "I(imports_pct^2)","fit_rev_pct:imports_pct", "l_pct:imports_pct", "k_pct:imports_pct", "exports_pct:imports_pct")
)
names(coef_elas_iv) <- var_elas_iv

coef_elas_ols <- list(
    "lag_rev_pct" = c("lag_rev_pct", "I(lag_rev_pct^2)","lag_rev_pct:l_pct", "lag_rev_pct:k_pct", "lag_rev_pct:exports_pct", "lag_rev_pct:imports_pct"),
    "l_pct" = c("l_pct", "I(l_pct^2)", "lag_rev_pct:l_pct", "l_pct:k_pct", "l_pct:exports_pct", "l_pct:imports_pct"),
    "k_pct" = c("k_pct", "I(k_pct^2)","lag_rev_pct:k_pct", "l_pct:k_pct", "k_pct:exports_pct", "k_pct:imports_pct"),
    "exports_pct" = c("exports_pct", "I(exports_pct^2)","lag_rev_pct:exports_pct", "l_pct:exports_pct", "k_pct:exports_pct", "exports_pct:imports_pct"),
    "imports_pct" = c("imports_pct", "I(imports_pct^2)","lag_rev_pct:imports_pct", "l_pct:imports_pct", "k_pct:imports_pct", "exports_pct:imports_pct")
)
...
size_var_mdl <- c(
    ...
    "fit_rev_pct:l_pct",
    "fit_rev_pct:k_pct",
    "fit_rev_pct:exports_pct",
    "fit_rev_pct:imports_pct",
    "lag_rev_pct:l_pct",
    "lag_rev_pct:k_pct",
    "lag_rev_pct:exports_pct",
    "lag_rev_pct:imports_pct",
    "l_pct:k_pct",
    "l_pct:exports_pct",
    "l_pct:imports_pct",
    "k_pct:exports_pct",
...
var_desc_ltx <- c(
    ...
    "Revenue $\\times$ Exports",
    "Revenue $\\times$ Imports",
    "Revenue$_{t-1}$ $\\times$ Labour",
    "Revenue$_{t-1}$ $\\times$ Capital",
    "Revenue$_{t-1}$ $\\times$ Exports",
    "Revenue$_{t-1}$ $\\times$ Imports",
    "Labour $\\times$ Capital",
    "Labour $\\times$ Exports",
    "Labour $\\times$ Imports",
    "Capital $\\times$ Exports",
    "Capital $\\times$ Imports",
    "Exports $\\times$ Imports",
    "Const."
)
...
var_desc_plt <- c(
    ...
    "Revenue (t-1) x Exports",
    "Revenue (t-1) x Imports",
    "Labour x Capital",
    "Labour x Exports",
    "Labour x Imports",
    "Capital x Exports",
...
save(
    ...
    avg_elas_df,
    reg_mrg_ls,
    file = "Code/Products/932.5-avg-elas-interactions.RData"
)
